<template>
    <div class="body">
        <head-top></head-top>
        <!-- 头部banner -->
        <div style="width: 100%;background-color: #35a13e; background: url('/sasstudent/img/banner.png') no-repeat center center;">
            <div class="header-banner">
                <img src="../assets/images/banner.png" alt="中小学生自适应学习平台">
            </div>
        </div>
        <div class="content">
            <!-- 自适应测评 孩子提分新方式 -->
            <div class="content-evaluating">
                ...
                <div class="content-evaluating-left">
                    ...
                    <dl class="dl-list left">
                        <dt @mouseover="setLeftPostionTV(0)" :class="hoverVal==0?'penActive':''">
                            首次测评
                        </dt>
                        <dd>首次测评，系统评估当前能力水平</dd>
                        <dt @mouseover="setLeftPostionTV(-317)" :class="hoverVal==-317?'penActive':''">
                            分析评估
                        </dt>
                        <dd>首次测评 分析评估 提分方案 测评完成</dd>
                        <dt @mouseover="setLeftPostionTV(-634)" :class="hoverVal==-634?'penActive':''">
                            提分方案
                        </dt>
                        <dd>完成推荐试题试卷，在顺其自然中提升学习水平</dd>
                        <dt @mouseover="setLeftPostionTV(-951)" :class="hoverVal==-951?'penActive':''">
                            测评完成
                        </dt>
                        <dd>评测完成，得到最终分析</dd>
                    </dl>
            ...
            <div class="head-bigImg">
                ...
                <div class="bannerButtom" style=''>
                    ...
                    <div class="titleOfHard" style="">
                        <h1>疑难问题随时提问</h1>
                        <p>无需家教，随时解答</p>
                    </div>
                    <div class="returnToHard greenButton">
                        疑难解答
                    </div>
                    ...
                    <div style="position: absolute;top: 1800px;width: 100%;height: 880px">
                        <div style="position:relative;height: 880px">
                            ...
                            <div @click="clickSmall('left')"
                                 style="top:456px;background: url('/sasstudent/img/doorbutton_06.jpg');width: 71px;height: 71px;z-index: 100;position: absolute;left: -2px"></div>
                            <div @click="clickSmall('right')"
                                 style="top:456px;background: url('/sasstudent/img/doorRight_08.jpg');width: 71px;height: 71px;z-index: 100;position: absolute;left: 1120px"></div>
                                        ...
                                        <ul ref="teacherList" class="teacher-list clearfix"
                                            ...
                                            <li class="teacher-item left" v-for="item in teacherList">
                                                <img :src="item.head" alt=""
                                                     onerror="javascript:this.src='/sasstudent/img/head.jpg'"
                    ...
                    <div class="content-customized" style="top: 0;position: absolute;width: 1900px;margin-left: -355px">
                        <div class="content-body">
                            <p class="title titleOfEvaluating" style="color: #ffffff;">量身定制</p>
...
//              {'tip': '优秀青年教师，山东省‘优秀辅导教师’，省市教育能手，市学科带头人，市骨干教师。'},
          ...
          {
            'teacherName': '许老师',
            'head': '/sasstudent/img/headThree.jpg',
...
<style lang="scss">
    ...
    .head-bigImg {
        ...
        height: 3380px;
        position: relative;
        background: url('/sasstudent/img/bottom_04.jpg') no-repeat center center;
        .two {
            position: absolute;
            top: 1300px;
            background: #3abfce;

            ...
            <div class="login-input">
                ...
                <div class="div" style="margin-top: 22px">
                    <input type="password" placeholder="请输入短信验证码" v-model="messageInput"
                           style="width: 150px;padding: 0 14px;border-left: #ccc 1px solid"/>
                ...
                <div class="div" style="margin-top: 22px">
                    ...
                    <input type="password" v-model="inputAccountpassword" placeholder="请输入您的密码"></input></div>
                <div class="div" style="margin-top: 22px">
                    <div class="icon-login">
                        <img src="../../assets/images/password.png"/>
                    </div>
                    <input type="password" v-model="inputAccountpassword1" placeholder="请再次输入您的密码"></input></div>
                ...
                <button class="orangeYellow" @click="AgreeRegister">提交</button>

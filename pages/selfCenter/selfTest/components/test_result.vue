    ...
    <div class="test_result" style="width: 100%">
        <template v-if="answerResult instanceof Object">
            ...
            <div class="item">
                ...
                <div class="content" style="height: auto;padding: 10px;" v-if="testType != '2'">
                ...
                <!--<ve-histogram :data="autoAssessmentChartData" :settings="autoAssessmentChartSettings"></ve-histogram>-->
            </div>


            <div class="item">
                <span class="icon-left"><i></i>做题详情</span>
                <el-button class="right show-paper showDefaultButton" @click="showModal = true">查看试卷
            ...
            <div class="item" v-if="testType != '2'">
            ...
            <div class="clearfix" v-if="testType != '2'">
                <div class="item left" style="margin-right: 25px;width: 432px;">
        ...
        <Modal
            ...
            <show v-if="showModal" :typeId="showId" :types="showTestType"></show>
            <div slot="footer"></div>
        </Modal>
    </div>
</template>
<script>
  ...
  export default {
    props: ['id', 'testType', 'getDataByURL'],
    data () {
      return {
        userName: '',
        showId: {
    ...
    methods: {
      ...
      init () {
        Util = this.$util;
        let {bind: hasBind = false} = (this.$route && this.$route.query || {bind:false});
        this.userName = this.$store.getters['user/info']('name') || this.$store.getters['user/info']('nickname');
        if (this.getDataByURL) { // 是否从
          let {id, testType} = this.$route.params;
          this.showId = id;
          this.showTestType = testType;
        }
        if (hasBind) {
          this.bindTestRes();
        } else {
      ...
      getAnswerResult () {
        let opt = {
          ajaxSuccess: this.answerResultCall,
          ajaxParams: {
            url: '/assessment/getAnswerResult',
            method: 'get',
            params: {
              id: this.showId
            }

    ...
    <div class="selfAnsweringQuestion-show">
        <div class="wrap">
            ...
            <div class="show-content">
                ...
                <div class="show-content-main imgMax" v-html="detail.content"></div>
                <!--<div class="img-wrap">-->
                <!--<img width="230" src="../../../assets/images/ques-1111.png" alt="">-->
                <!--</div>-->
                <div class="notic clearfix">
                    <span>难题原因</span>
                    <p class="tip" v-html="detail.reason">
                    </p>
                </div>
            </div>
        </div>
        <div class="wrap answer" style="margin:30px 0">
            ...
            <dl class="clearfix" v-for="(item,index) in list" :key="index">
                ...
                <dd class="left">
                    ...
                    <p class="bottom">
                        ...
                        <el-button class="right whiteButton"
                                   v-if="item.isAdopt==0&&Aready==0&&item.replyUserId!=$store.state.user.info.id&&detail.questionerId==$store.state.user.info.id&&!detail.whetherTimeOut"
                                   @click="modify(index,item.id)">采纳答案
                        </el-button>
                    </p>
                </dd>
            </dl>
    ...
    methods: {
      ...
      init () {
        ...
        this.queryQptions = {
          ...
          this.queryQptions2 = {//更改采纳
            url: api.changeAccept.path,
            params: {
              problemId: this.$route.query.id,
              problemReplyId: ''
            },
      ...
      modify (index, i) {
        ...
        this.queryQptions2.params.problemReplyId = i
        this.changeAdopt()
      },

        ...
        <div class="selfContent clearfix">
                        ...
                        <dl>
                            ...
                            <dd class="introduce-tip">我的积分：
                                <router-link to="integralList">
                                    <span style="color: #434343">{{$store.state.user.userIntegral}}积分</span>
                                </router-link>
                            </dd>
                            <!--<dd class="introduce-tip">我的勋章：</dd>-->
                            <dd class="introduce-tip">
                                <p>&nbsp;余&nbsp;&nbsp;&nbsp;额&nbsp;&nbsp;<span style="margin-left: 2px">： </span>
                                    {{userInfo.b}}学币
            ...
            <div class="pay-car clearfix">
                <div style="position:relative;height: 100px">
                    <img src="/sasstudent/img/shopcar.jpg" alt=""/>
                    <img style="top: 36px;width: 41px;height: 70px;z-index: 10;margin-top: -6px"
                         src="/sasstudent/img/write_06.jpg" alt=""/>
                    <router-link to="/selfCenter/selfShoppingCart">
                        <span class="car" style="top: 0;"></span>
                    </router-link>
                    <router-link to="/selfCenter/suggestion">
                        <span class="msg" style="top: 36px;"></span>
                    </router-link>
                    <a href="javascript:scroll(0,0)">
                        <span class="top" style="top: 72px;"></span>
                    </a>
                </div>
            </div>
        </div>
